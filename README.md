...
### Schritt 2 — Groq API Key holen (kostenlos)
1. Gehe auf https://console.groq.com
2. Account erstellen (kostenlos, nur Email)
...
- Groq API: **komplett kostenlos** (Free Tier: 14.400 Anfragen/Tag, extrem schnell)
